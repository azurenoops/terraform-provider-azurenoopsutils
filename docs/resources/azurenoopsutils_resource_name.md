...
page_title: "azurenoopsutils_resource Resource - terraform-provider-azurenoopsutils"
subcategory: "Cloud Automation"
description: |-
  .
---

# azurenoopsutils_resource_name (Resource)

The resource azurenoopsutils_resource_name implements a set of methodologies to apply consistent resource naming using Azure NoOps Accelerator.

The azurenoopsutils_resource_name provides more flexibility and will be updated on a regular basis as new Azure services are released.
